<div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 115, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <a href="#">
                                <h1 class="text-primary mb-0">Kyla Aksesories</h1>
                                <p class="text-secondary mb-0">Tersedia semua kebutuhan anda</p>
                            </a>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-4">Kami menghadirkan kemudahan, pilihan terbaik, dan layanan cepat yang membuat pengalaman belanja Anda lebih menyenangkan!</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            <h4 class="text-light mb-3">Hubungi Kami</h4>
                            <p>Alamat: Jl. Dr Kayadoe, Kel. Kudamati, Kec. Nusaniwe, Kota Ambon, Ambon 97116</p>
                            <p>Email: evinnaja@gmail.com</p>
                            <p>Hp: 0821-9470-6382</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Kyla Aksesories</a> <span id="currentYear"></span>. All right reserved.</span>
                    </div>
