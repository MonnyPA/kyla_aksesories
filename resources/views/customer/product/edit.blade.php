                ...
                <section id="multiple-column-form">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-header">
                            <h3 class="card-title text-warning">Edit Product</h3>
                        </div>
                            ...
                            <form class="form" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    @endif
                                        ...
                                        id="img"
                                        class="form-control"
                                        placeholder="Insert Gambar Menu"
                                        name="img"
                                        value="{{ asset('img_product_upload/' . $product->img) }}"
                                        />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="flexSwicthCheckChecked" name="is_active" value="1" {{ $product->is_active == 1 ? 'checked' : '' }}>
